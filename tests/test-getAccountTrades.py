...
test = bn.getAccountTrades(queryParams)
print
...
test = bn.getAccountTrades(queryParams)
print
queryParams = {'symbol':'SALTBTC','timestamp':1507770491000,'recvWindow':123435234,'fromId':12345678}
...
test = bn.getAccountTrades(queryParams)
print
queryParams = {'symbol':12.5,'fromId':3334344}
